"use client";
// Adapted from React Bits Waves, David Haz. See LICENSE.md and README.md.
...
export function Waves({
  ...
  useEffect(() => {
    ...
    let visible = true;
    const running = () => visible && !document.hidden && !reduced.matches && document.documentElement.dataset.motion !== "paused";
  ...
  return <div ref={containerRef} className={`waves ${className}`} aria-hidden="true"><canvas ref={canvasRef} className="waves-canvas" /></div>;
}
