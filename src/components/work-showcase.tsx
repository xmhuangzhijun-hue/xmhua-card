...
export function WorkShowcase() {
  return <main className="work-page">
    <header className="work-nav"><Link className="work-brand" href="/" aria-label="返回黄智军首页"><Image src="/xmhua-mark.svg" alt="" width={27} height={27} priority/><strong>黄智军</strong></Link><nav aria-label="作品页导航"><a href="#systems">工程系统</a><a href="#principles">原则</a><a href="https://github.com/xmhuangzhijun-hue" target="_blank" rel="noreferrer">GitHub <ArrowUpRight size={14}/></a><CommandTrigger /></nav></header>
    ...
    <section className="work-contact" data-reveal><p>如果你在招聘 AI Agent、AI 应用工程或 FDE，欢迎直接检查我的工作。</p><a href="https://github.com/xmhuangzhijun-hue" target="_blank" rel="noreferrer">查看全部公开仓库 <ArrowUpRight size={18}/></a></section><footer className="work-footer"><Link href="/"><ArrowLeft size={15}/> 返回博客首页</Link><span>© 2026 黄智军 · Public engineering portfolio · <a className="work-icp" href="https://beian.miit.gov.cn/" target="_blank" rel="noreferrer noopener">闽ICP备2026035561号-1</a></span></footer>
  </main>;
}
