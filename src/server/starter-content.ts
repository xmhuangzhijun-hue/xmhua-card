...
export function createStarterContent(name: string): HomepageContent {
  return {
    ...
    sections: {
      articles: { eyebrow: "最新文章", title: "从这里开始记录。", description: "发布你的第一篇文章，让访客认识你的想法。" },
      products: { eyebrow: "代表作品", title: "展示你正在做的事。", description: "项目、服务、产品或任何值得被看见的作品。" },
    ...
    products: [{ id: 1, image: "/sites/hooosberg-com-db2980a2/root-8a5edab2/images/mood-button.png", name: "我的第一个作品", subtitle: "作品简介", summary: "用一句话说明它为谁解决了什么问题。", platform: "Web", href: "#" }],
    directory: {
    ...
    socials: [{ id: 1, icon: "/sites/hooosberg-com-db2980a2/root-8a5edab2/icons/github.svg", label: "GitHub", handle: "your-name", href: "#" }],
