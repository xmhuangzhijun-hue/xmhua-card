...
- 子页面（`/notes`、笔记详情、`/privacy`、`/terms`、`/work`）页脚补齐「© 2026 黄智军 · 闽ICP备2026035561号-1」备案行，此前只有首页页脚有备案号。
...
- 公开站品牌文案由 `XMHUA` 统一为「黄智军」：页面标题与描述、`/work` 页头与页脚、独立页面页头、无障碍标签均随首页改名（`XMHUA Card` 产品名与 GitHub handle 不变）。
